...
<title>Web Page Update Demo</title>
  ...
  <body style="background-color: #efefef" onload="process()">
    ...
    <header>
      <div class="navbar fixed-top">
          <div class="container">
            <div class="navtitle">MSB Traffic</div>
    ...
    <main class="container" style="margin-top:70px">
      <div class="category">Traffic Readings</div>
      ...
      <col span="2"style="background-color:rgb(0,0,0); color:#FFFFFF">
      <tr>
        <th colspan="1"><div class="heading">Location</div></th>
  ...
  <footer div class="foot" id = "temp" >MSB Traffic Monitor 2024-Enginnering Innovations, LLC</div></footer>
